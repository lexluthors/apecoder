...
public class CircularProgressBar extends ProgressBar
{
	...
	public CircularProgressBar(Context context, AttributeSet attrs, int defStyle)
	{
		...
		CircularProgressDrawable.Builder builder = new CircularProgressDrawable.Builder(context).sweepSpeed(sweepSpeed).rotationSpeed(rotationSpeed)
				.strokeWidth(strokeWidth).minSweepAngle(minSweepAngle).maxSweepAngle(maxSweepAngle)
				.style(capRound ? CircularProgressDrawable.Style.ROUNDED : CircularProgressDrawable.Style.NORMAL);
