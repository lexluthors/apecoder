...
//		Toast.makeText(context, strResId, Toast.LENGTH_SHORT).show();
    ...
    public static Toast showToastWithImg(final String tvStr, final int imageResource) {
        if (toast2 == null) {
            toast2 = new Toast(App.getAppContext());
        }
        View view = LayoutInflater.from(App.getAppContext()).inflate(R.layout.toast_custom, null);
    ...
    public static void centerTopToast(Context context, String content) {
        // 获取屏幕高度
